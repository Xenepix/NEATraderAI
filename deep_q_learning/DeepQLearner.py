...
class DeepQNetwork(nn.Module):
    def __init__(self, learning_rate, input_dims, fc1_dims, fc2_dims, n_actions):
        ...
        # The goal will next to implement customizable structure during pre-training
    ...
    def forward(self, state):
        ...
        actions = self.fc3(x)           # Output layer
...
class Agent:
    def __init__(self, gamma, eps, lr, input_dims, batch_size, n_actions,
                 max_mem_size=100000, eps_end=0.01, eps_dec=0.99):
        self.gamma = gamma
        self.eps = eps
    ...
    def choose_action(self, observation):
        if np.random.random() > self.eps:   # Estimation
